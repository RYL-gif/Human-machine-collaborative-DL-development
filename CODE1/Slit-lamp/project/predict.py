...
test_root = "../testing dataset"  # testing dataset    confirm
...
if not exter_no_label:
	...
	acc = (test_cm[2, 2] + test_cm[1, 1] + test_cm[0, 0]) / np.sum(test_cm)
	print('ACC:' + str(acc))
	...
	test_result = {
		...
		'acc': round(acc, 4),
		'confusion matrix': '[[{}, {}, {}], [{}, {}, {}], [{}, {}, {}]]'.format(test_cm[0, 0], test_cm[0, 1],test_cm[0, 2],
																				test_cm[1, 0], test_cm[1, 1],test_cm[1, 2],
																				test_cm[2, 0], test_cm[2, 1],test_cm[2, 2]),
		}
