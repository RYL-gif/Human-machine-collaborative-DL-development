...
test_root = "../confirm/india"  # testing dataset    confirm/india confirm/jama
...
# scores.to_csv(
# 	os.path.join(os.path.join(os.path.join(name, 'test_auc{}'.format(str(round(test_auc, 2)))), 'scores.txt')), sep=',',
# 	index=False)
scores.to_csv(os.path.join(name, area, 'scores.txt'), sep=',',index=False)
