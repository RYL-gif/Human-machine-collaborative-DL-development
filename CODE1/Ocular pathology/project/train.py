...
number_of_trainsample=2100
number_of_validationsample=700
...
def train():
    ...
    if multi_cls:
        ...
        # opt = optimizers.Adam(lr=1e-2, epsilon=1e-06)
        opt = optimizers.SGD(lr=1e-2, decay=1e-7, momentum=0.95, nesterov=True)
