...
#network parameters
model_name = 'effientnetB4' # resnet50  inceptionv3  effientnetB4
...
number_of_trainsample=992
number_of_validationsample=332
...
def train():
    ...
    if multi_cls:
        ...
        opt = optimizers.Adam(lr=1e-3, epsilon=1e-07)
        # opt = optimizers.SGD(lr=1e-3, decay=1e-5, momentum=0.85, nesterov=True)
