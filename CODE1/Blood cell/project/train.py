...
#network parameters
model_name = 'inceptionv3' # resnet50  inceptionv3  effientnetB4  inceptionresnetv2
...
number_of_trainsample=5120
number_of_validationsample=1279
...
def train():
    ...
    if multi_cls:
        ...
        opt = optimizers.Adam(lr=1e-3, epsilon=1e-07)
        # opt = optimizers.SGD(lr=1e-4, decay=1e-5, momentum=0.95, nesterov=True)
